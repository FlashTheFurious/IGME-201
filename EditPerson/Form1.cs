    ...
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
             ...
             * 1. Increase the size of the form by changing:
               ...
               2. Place 7 radio buttons on the form to the right of the Combo Box, Name and Email fields.
                    They should be defined as:
                            ...
                            (Name): freshRadioButton  sophRadioButton  juniorRadioButton    seniorRadioButton
            ...
            */
            ...
            //Adding event handlers delegate methods to the class radio buttons
            ...
            //Adding event handlers delegate methods to the gender radio buttons
            ...
            //Checking Gender Radio Button Based on person.eGender , with 'them' as the default
            if (person.name == null)
            {
            ...
            //Check if this is a Student Object, if yes then 
            //Check the class radio button based on the student.eCollegeYear , Default to 'Senior'
            if (person.GetType() == typeof(Student))
            {
                ...
                else if (stud.eCollegeYear == CollegeYear.junior)
                {
                    juniorRadioButton.Checked = true;
                }
                else if (stud.eCollegeYear == CollegeYear.sophomore)
                {
                    sophRadioButton.Checked = true;
                }
                else if (stud.eCollegeYear == CollegeYear.freshman)
                {
        ...
        private void TypeComboBox__SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cb.SelectedIndex == 0)
            {
                ...
                //Set classGroupBox to true and make it visible
            ...
            else
            {
                ...
                //Set classGroupBox to false and make it invisible
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if (person.GetType() == typeof(Student))
            {
                ...
                //Set student.eCollegeYear based on the classRadioButton checked
            ...
            // Set person.eGender based on which GenderRadioButton is Checked
